...
const user = {
  ...
  getUsername: function(){
    return this.username; //For accessing current object
  }
}
...
/*
 Below we have the constructor Animal.  The eat method is using the "this" keyword.  Use the "new" keyword to assign context to "this", and save the instance to a variable 
 named animal1.  You can pass anything you want in for name, species and food.
*/
...
//Code Here
 const animal1 = new Animal('Test', 'Test Species', 'Chowmein')
////////// PROBLEM 3 //////////
